package com.alkhalildevelopers.otptest;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verificationCodeT = findViewById(R.id.verificationCodeID);
        getCodeBtn = findViewById(R.id.getcodeBtnID);
        verifyBtn = findViewById(R.id.codeVerificationBtnID);
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                ...
                                Toast.makeText(MainActivity.this, "You entered a wring code", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                });
